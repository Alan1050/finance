...
const Login:React.FC = () =>{
    ...
    useEffect(() => {
      ...
      return (
        <div className="h-screen bg-gradient-to-b from-cyan-600 to-teal-800">
          <main>
                ...
                <div className="row">
                  ...
                  <form className="bg-black rounded-lg">
                    ...
                    <div>
                      ...
                      <p>No estas registrado? <a href="">click aqui</a></p>
                    </div>
                  </form>
                </div>
              </div>
